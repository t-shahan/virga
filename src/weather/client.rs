...
pub fn fetch_air_quality(lat: f64, lon: f64) -> Result<Option<AirQuality>> {
    let url = format!("https://air-quality-api.open-meteo.com/v1/air-quality?latitude={lat}&longitude={lon}&hourly=us_aqi&current=us_aqi&domains=cams_global");
